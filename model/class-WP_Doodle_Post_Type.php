...
class WP_Doodle_Post_Type {
	...
	public static function init( $plugin = NULL ) {
		...
		$labels = array(
			'name'               => __( 'Doodle Polls', 'doodle_polls' ),
			'singular_name'      => __( 'Doodle Poll', 'doodle_polls' ),
			'add_new'            => __( 'Add new', 'doodle_polls' ),
			'all_items'          => __( 'All Polls', 'doodle_polls' ),
			'add_new_item'       => __( 'Add new Doodle Poll', 'doodle_polls' ),
			'edit_item'          => __( 'Edit Poll', 'doodle_polls' ),
			'new_item'           => __( 'New Doodle Poll', 'doodle_polls' ),
			'view_item'          => __( 'View Doodle Poll', 'doodle_polls' ),
			'search_items'       => __( 'Search Doodle Polls', 'doodle_polls' ),
			'not_found'          => __( 'No Polls found', 'doodle_polls' ),
			'not_found_in_trash' => __( 'No Polls found in Trash', 'doodle_polls' ),
			'parent_item_colon'  => __( 'Parent Poll', 'doodle_polls' ),
			'menu_name'          => __( 'Doodle Polls', 'doodle_polls' )
		);
		$args = array(
			'label'                => __( 'Doodle Poll', 'doodle_polls' ),
			'labels'               => $labels,
			'description'          => __( 'Local representation of your doodle polls', 'doodle_polls' ),
			'public'               => TRUE,
